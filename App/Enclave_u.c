...
sgx_status_t ecall_create_randomness_flat(sgx_enclave_id_t eid, int M, int* N, int L, int b, int size_of_lr, int size_of_g, int* location_randomness, int* relatived_randomness, int* global_randomness)
{
	sgx_status_t status;
	ms_ecall_create_randomness_flat_t ms;
	ms.ms_M = M;
	ms.ms_N = N;
	ms.ms_L = L;
	ms.ms_b = b;
	ms.ms_size_of_lr = size_of_lr;
	ms.ms_size_of_g = size_of_g;
	ms.ms_location_randomness = location_randomness;
	ms.ms_relatived_randomness = relatived_randomness;
	ms.ms_global_randomness = global_randomness;
